  ...
  return (
    <section ref={heroRef} className="relative pt-20 pb-24 overflow-hidden">
      ...
      <div className="container px-4">
        {/* More eye-catching badge - moved to the left column */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
                ...
                <div className="relative h-full flex items-center justify-center">
                  <div className="w-full max-w-lg">
                    ...
                    <div className={cn(
                      ...
                      <motion.div 
                        className="glass-card p-6 rounded-xl max-w-md flex flex-col items-center text-center border border-white/30"
                      ...
                      >
                        ...
                        <h4 className="text-lg font-medium mb-1">Upload Documents</h4>
                        <p className="text-muted-foreground text-sm mb-4">
                          Easily upload your documents in any format.
                        </p>
                        <motion.div 
                          className="glass p-3 w-full rounded-lg border border-white/30 flex items-center justify-center gap-3"
                    ...
                    <div className={cn(
                      ...
                      >
                        ...
                        <h4 className="text-lg font-medium mb-1">Add Recipients</h4>
                        <p className="text-muted-foreground text-sm mb-4">
                          Add who needs to sign and in what order.
                        </p>
                        <motion.div 
                          className="glass p-3 w-full rounded-lg border border-white/30 flex flex-col gap-2"
                          whileHover={{ y: -2, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.05)" }}
                        >
                          <motion.div 
                          ...
                          >
                            <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center text-xs font-medium text-blue-700">1</div>
                            <span className="text-sm">john@example.com</span>
                            <Badge variant="outline" className="ml-auto text-xs py-0">Signer</Badge>
                          </motion.div>
                          <motion.div 
                            className="flex items-center gap-2"
                            initial={{ opacity: 0, x: -10 }}
                          ...
                          >
                            <div className="w-6 h-6 rounded-full bg-purple-100 flex items-center justify-center text-xs font-medium text-purple-700">2</div>
                    ...
                    <div className={cn(
                      ...
                      >
                        ...
                        <h4 className="text-lg font-medium mb-1">Sign Documents</h4>
                        <p className="text-muted-foreground text-sm mb-4">
                          Recipients sign with just a few clicks.
                        </p>
                        <motion.div 
                          className="glass p-3 w-full rounded-lg border border-white/30 flex items-center justify-center"
                          whileHover={{ y: -2, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.05)" }}
                        >
                          <div className="relative w-full h-20 bg-white/10 rounded border border-dashed border-white/30 flex items-center justify-center">
                            <motion.img 
                    ...
                    <div className={cn(
                      ...
                      >
                        <motion.div 
                          className="w-14 h-14 rounded-full bg-green-500/10 flex items-center justify-center mb-3"
                        ...
                        <h4 className="text-lg font-medium mb-1">Complete & Secure</h4>
                        <p className="text-muted-foreground text-sm mb-4">
                          All parties receive a legally binding copy.
                        </p>
                        <motion.div 
                          className="glass p-3 w-full rounded-lg border border-white/30 flex items-center justify-between"
                          whileHover={{ y: -2, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.05)" }}
            ...
            <motion.div 
              className="absolute -bottom-4 -right-4 w-12 h-12 rounded-full bg-gradient-to-br from-primary/30 to-primary/10 blur-xl"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.5, 0.7, 0.5],
              }}
            ...
            />
            <motion.div 
              className="absolute -top-4 -left-4 w-20 h-20 rounded-full bg-gradient-to-tr from-primary/20 to-primary/10 blur-xl"
              animate={{
                scale: [1, 1.1, 1],
                opacity: [0.4, 0.6, 0.4],
              }}
